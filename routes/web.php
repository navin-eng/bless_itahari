...
Route::get('/about/us', [Frontend::class, 'aboutUs'])->name('about.us');
...
Route::middleware('webGuard')->group(function () {
    ...
    Route::post('/admin/dashboard/gallery/bulk-delete', [GalleryController::class, 'bulkDelete'])->name('gallery.bulkDelete');
    ...
    Route::match(['get', 'post'], '/admin/dashboard/aboutus/structured', [AboutUsController::class, 'updateStructured'])->name('aboutus.structured.update');
